...
# t分布/t検定: 母集団の標準偏差(=母標準偏差)が不明なときに用いる分布。標本の大きさが30以下の際に用いる。基本的に不偏標準偏差を用いる。

# t分布を考えるとき、自由度は (標本サイズ - 1) の値となる。

# 例1: ave=125で正規分布に従う標本から10サンプルを抽出たところ、抽出したサンプルは平均121.8, 不偏標準偏差=4.2であったとき、サンプルの平均値が125以上である確率
...
# 2標本t検定: データが2つあるとき、それぞれの標本平均に差があるかどうかを調べる際に用いる。

# 例1: 独立2群-2つのデータに関連性がないとき

# データ (dataAとdataBに関連性はない)

# -------|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|--
#  dataA | 312 | 304 | 295 | 310 | 291 | 287 | 309 | 311 | 294 | 289 |
# -------|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|--
#  dataB | 293 | 289 | 305 | 286 | 304 | 312 | 309 | 314 | 307 | 309 |
# -------|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|--

from scipy.stats import ttest_ind # ttest_indを導入

# データ作成
gA = [312, 304, 295, 310, 291, 287, 309, 311, 294, 289]
gB = [293, 289, 305, 286, 304, 312, 309, 314, 307, 309]

# p値を導出
t, p = ttest_ind(gA, gB)


# 例2: 関連2群-2つのデータに関連性があるとき

# データ (dataCとdataBに関連性がある)

# -------|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|--
#  dataC | 134 | 149 | 124 | 184 | 161 | 137 | 146 | 152 | 149 | 114 |
# -------|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|--
#  dataD | 129 | 135 | 121 | 163 | 152 | 134 | 120 | 156 | 141 | 121 |
# -------|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|--

from scipy.stats import ttest_rel # ttest_relを導入

# データ作成
gC = [134, 149, 124, 184, 161, 137, 146, 152, 149, 114]
gD = [129, 135, 121, 163, 152, 134, 120, 156, 141, 121]
